...
metadata:
  hermes:
    ...
    related_skills: [term-mail-cli, google-workspace]
tags: ["email", "triage", "inbox", "prioritize", "draft", "reply", "productivity"]
---

# Email Inbox Triage

Turn a mailbox into a bounded queue of decisions. This skill owns thread-aware prioritization and reply policy; connector skills (`term-mail-cli`, `google-workspace`) own provider commands.
