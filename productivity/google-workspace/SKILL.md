...
metadata:
  hermes:
    ...
    related_skills: [term-mail-cli]
tags: ["google", "gmail", "calendar", "drive", "docs", "sheets", "contacts", "email", "oauth", "gws"]
---
...
- **Email only** → They don't need this skill at all. Use the `term-mail-cli` skill
  instead — it works with a Gmail App Password (Settings → Security → App
  Passwords) and takes 2 minutes to set up. No Google Cloud project needed.
  Load the `term-mail-cli` skill and follow its setup instructions.
