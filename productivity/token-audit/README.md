...
Session: 47 turns
Input:   12,304 tokens
Output:   3,891 tokens (drytalk)
Baseline: 11,247 tokens (estimated without drytalk)
Saved:    7,356 tokens (~65%)
Est. rule overhead: 58,750 (input, ~1,250/turn over 47 turns)
Est. net: -51,394 (drytalk cost more than it saved for this workload — consider turning it off)
```
