...
metadata:
  hermes:
    ...
    related_skills: [code-cli-ctrl, code-task-runner, ai-task-agent-cli]
tags: ["hermes", "configure", "theme", "extend", "orchestrate", "bot", "gateway", "cli", "setup", "multi-agent", "spawning"]
---
